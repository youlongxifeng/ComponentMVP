...
import com.alc.library_common.provier.AppProvider;
...
public class RetrofitCreateLiveDataHelper {
    ...
    private static volatile RetrofitCreateLiveDataHelper instance;
    ...
    public static RetrofitCreateLiveDataHelper getStaticInstance() {
    ...
    private static class SingletonHoler {
         ...
         * 静态初始化器，由JVM来保证线程安全
         */
        private static RetrofitCreateLiveDataHelper instance = new RetrofitCreateLiveDataHelper();
    }
